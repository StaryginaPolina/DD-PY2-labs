...
class House:
    ...
    def add_flors(self, flors: int) -> None:
        ...
        :raise ValueError: Если количество этажей меньше 1
        ...
        if not isinstance(flors, int):
            raise TypeError("Количество этажей целое")
        if flors < 1:
            raise ValueError("Количество этажей не меньше 1")
        ...
    ...
    def add_entrsnces(self, entrsnces: int) -> None:
        ...
        :raise ValueError: Если количество подъездов  меньше 1
...
class Telephone_tariff:
    ...
    def add_gigabyte(self, gigabyte: (int, float)) -> None:
        """
        Добавим гигабайтов в тариф

        :param gigabyte: Сколько гигабайт добавим
